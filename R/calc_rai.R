...
#' @examples
#' line <- sf::st_read("data-raw/zamzibar_osm_road.shp") ##road network
#' urban <- sf::st_read("data-raw/urban_tanzania.shp") ##urban area
#' admin <- sf::st_read("data-raw/zanzibar_dhs_adm1.shp") ##administrative boundaries
